...
// Shil: skip the chat panel registration entirely — removes the "Build with Agent"
// view from the secondary sidebar. The chat infrastructure is kept for Shil's own
// agent later; only the UI surface is suppressed.
