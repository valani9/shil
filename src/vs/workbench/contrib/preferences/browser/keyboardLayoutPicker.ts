...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in the browser environment.')}`,
	`// ${nls.localize('doc', 'Run "Developer: Inspect Key Mappings (JSON)" from the Command Palette.')}`,
	``,
